...
import { IFiles } from '../redux/files/filesApi';
...
const columns: ColumnsType<IFiles> = [
  {
    title: 'id',
    dataIndex: 'id',
    width: 50,
  ...
  },
  {
    ...
    render: (img) => <Image
                        ...
                        src={process.env.REACT_APP_SERVER_URL + '/files/' + 'cam03.png'}
                        // preview={{
                        //   src: `http://158.160.2.88:7777/api/files/${img}`,
                        // }}
                        preview={{
                          src: process.env.REACT_APP_SERVER_URL + '/files/' + img,
                        }}
                        alt='img'
                        width={25}
                        height={25}
...
const _Table = ({tableData}: {tableData: IFiles[]}) => {
  return (
    <Table
